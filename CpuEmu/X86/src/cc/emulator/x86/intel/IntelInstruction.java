...
//    }
    ...
    public String getRegMnemonic(int reg, int w){
...
//    immediate: 5, -24, 3Fh, 10001101b, 等等.
    ...
    public String getRMFieldString(int w, int mod, int reg, int rm){
        switch(mod){
            case 0b00:
                if(rm==0b110)
                    return ""+disp;
